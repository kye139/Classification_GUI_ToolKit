...
BEGIN_MESSAGE_MAP(COutputTree, CTreeCtrl)
	ON_NOTIFY_REFLECT(TVN_SELCHANGED, &COutputTree::OnTvnSelchanged)
	ON_NOTIFY_REFLECT(NM_CLICK, &COutputTree::OnNMClick)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// COutputTree 메시지 처리기

// BOOL COutputTree::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT* pResult)
// {
// 	BOOL bRes = COutputTree::OnNotify(wParam, lParam, pResult);
// 
...
// 선택된 이미지 항목 속성 창에 출력.
void COutputTree::OnTvnSelchanged(NMHDR *pNMHDR, LRESULT *pResult)
{
...
BOOL COutputTree::PreTranslateMessage(MSG* pMsg)
{
...
void COutputTree::OnNMClick(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
